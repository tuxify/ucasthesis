...
%% Last modified: 2019-11-29 16:49
%%================================================
\ucassetup{
  %******************************
  % 注意：
  ...
  cmajor={化学工程},
  cauthor={赵钱孙},
  csupervisor={吴郑王\hspace{2\ccwd}教\hspace{\ccwd}授},% 导师
  csupervisorplace={中国科学院大连化学物理研究所},% 导师单位
  ccosupervisor={李\hspace{\ccwd}周\hspace{2\ccwd}研究员}, % 辅助导师
  % ccosupervisorplace={中国科学院青岛生物能源与过程研究所}, % 默认与导师单位相同
